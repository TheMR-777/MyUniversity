...
namespace Result
{
        ...
        // Result Card
            ...
            for( int i=0 ; i < students.size() ; i++ )
            {
                // Name Generation
                    ...
                    Utilities::spaces(students[i].name.size());
    ...
    void Subject_wise(const vector<Profile> &students)
    {
        // Initializing Temporary Stuff
            ...
            for ( int i=0 ; i < students[0].subjects.size() ; i++ )
            {
                ...
                for( int j=0 ; j < students.size() ; j++ )
                {
                    // Name Generation
                        ...
                        Utilities::spaces(students[j].name.size());

                    // Obtained Marks

                        cout << students[j].subjects[i].o_marks;
                        Utilities::spaces(Utilities::float_count(students[j].subjects[i].o_marks) , 17);

                    // Total Marks

                        cout << students[j].subjects[i].t_marks;
                        Utilities::spaces(Utilities::float_count(students[j].subjects[i].t_marks) , 17);
            ...
            for ( int i=0 ; i < students.size() ; i++ )
            {
                ...
                for( int j=0 ; j < students[i].subjects.size() ; j++ )
                {
                    // Name Generation
                        ...
                        Utilities::spaces(students[i].subjects[j].name.size());

                    // Obtained Marks

                        cout << students[i].subjects[j].o_marks;
                        Utilities::spaces(Utilities::float_count(students[i].subjects[j].o_marks) , 17);

                    // Total Marks

                        cout << students[i].subjects[j].t_marks;
                        Utilities::spaces(Utilities::float_count(students[i].subjects[j].t_marks) , 17);

                    // Percentage

                        flt_temp = class_function::PT_AGE(students[i].subjects[j].o_marks , students[i].subjects[j].t_marks);
                        cout << flt_temp;
                        Utilities::spaces(Utilities::float_count(flt_temp) ,10);
