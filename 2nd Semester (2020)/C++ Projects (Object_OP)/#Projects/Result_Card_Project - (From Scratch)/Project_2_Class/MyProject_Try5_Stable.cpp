...
void Settings(vector<Subject> &subjects , int temp_i , string temp_s )
{
    ...
    // Settings Menu
        ...
        cout << " |                                                                 |" << endl;
        cout << " | [ 1 ] - Set Pre-Configuations for Subjects                      |" << endl;
...
void Student_wise(const vector<Profile> &students)
{
    ...
    // Result Card
        ...
        for ( int i=0 ; i < students.size() ; i++ )
        {
            ...
            cout << endl;
            cout << " +----------------------------------------------------------------------------------------------------+" << endl;
            cout << " | Student [ " << i+1 << " / " << students.size() << " ] - " << students[i].name; spaces(students[i].name.size() , 70); cout << "//////// |" << endl;
            cout << " +----------------------------------------------------------------------------------------------------+" << endl;
            ...
            for( int j=0 ; j < students[i].subjects.size() ; j++ )
            {
                // Name Generation
                    ...
                    spaces(students[i].subjects[j].name.size());

                // Obtained Marks

                    cout << students[i].subjects[j].o_marks;
                    spaces(float_count(students[i].subjects[j].o_marks) , 17);

                // Total Marks

                    cout << students[i].subjects[j].t_marks;
                    spaces(float_count(students[i].subjects[j].t_marks) , 17);
    ...
    // Decision
        ...
        switch (temp_i)
        {
            case 1:
            {
                ...
                {
                    Input(students , subjects , temp_i , temp_s , temp_f);
                    cout << endl;
                    break;
                }
