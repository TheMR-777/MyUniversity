...
- Removed : Annoying Interface after List Generation

- Fixed : A Major Issue. Subject-wise list was exceeding the total Subjects.
- Fixed : Subject wise function was not sorting the first Subject.
- Fixed : Error were not displaying on Output Generation Screen.

- Added : Error Messages
- Added : More Options in some Interface Menus
