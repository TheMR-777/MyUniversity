...
namespace Utilities
{
    ...
    void spaces(ofstream &FILE , int size_in , int required = 30 )
    {
        int loop = required - size_in;
...
namespace Result_External
{
    void Result_Gen(const vector<Profile> &students)
    {
        // Initializing Temporary Stuff
            ...
            ofstream General_File ("General_List.txt");
            string stg_t;
        ...
        // Result Card
            ...
            for( int i=0 ; i < students.size() ; i++ )
            {
                ...
                // Percentage
                    ...
                    General_File << flt_temp;
                    Utilities::spaces(General_File , Utilities::float_count(flt_temp) ,10);
    ...
    void Subject_wise(vector<Profile> &students)
    {
        ...
        // Result Card
            ...
            {
                ofstream Brilliant_Student ( (students[0].subjects[i].name + ".txt") );
                ...
                for( int j=0 ; j < students.size() ; j++ )
                {
                    ...
                    // Percentage
                        ...
                        Brilliant_Student << flt_temp;
                        Utilities::spaces(Brilliant_Student , Utilities::float_count(flt_temp) ,10);
    ...
    void Student_wise(const vector<Profile> &students)
    {
        ...
        // Result Card
            ...
            for ( int i=0 ; i < students.size() ; i++ )
            {
                ofstream Genius_Student ( (students[i].name + ".txt") );
                ...
                for( int j=0 ; j < students[i].subjects.size() ; j++ )
                {
                    ...
                    // Percentage
                        ...
                        Genius_Student << flt_temp;
                        Utilities::spaces(Genius_Student , Utilities::float_count(flt_temp) ,10);

                    // Roll_Number

                        if (flt_temp >= 85 && flt_temp <= 100)
                        {
                            stg_t = "A     | 4.00";
                        }
                        else if (flt_temp >= 80 && flt_temp <= 84)
                        {
                            stg_t = "A-    | 3.70";
                        }
                        else if (flt_temp >= 75 && flt_temp <= 79)
                        {
                            stg_t = "B+    | 3.30";
                        }
                        else if (flt_temp >= 70 && flt_temp <= 74)
                        {
                            stg_t = "B     | 3.00";
                        }
                        else if (flt_temp >= 65 && flt_temp <= 69)
                        {
                            stg_t = "B-    | 2.70";
                        }
                        else if (flt_temp >= 61 && flt_temp <= 64)
                        {
                            stg_t = "C+    | 2.30";
                        }
                        else if (flt_temp >= 58 && flt_temp <= 60)
                        {
                            stg_t = "C     | 2.00";
                        }
                        else if (flt_temp >= 55 && flt_temp <= 57)
                        {
                            stg_t = "C-    | 1.70";
                        }
                        else if (flt_temp >= 50 && flt_temp <= 54)
                        {
                            stg_t = "D     | 1.00";
                        }
                        else
                        ...
                        Genius_Student << stg_t;
                        Utilities::spaces(Genius_Student , stg_t.size() ,25);
                        Genius_Student << "|" << endl;
            ...
            for ( int i=0 ; i < students.size() ; i++ )
            {
                ...
                for( int j=0 ; j < students[i].subjects.size() ; j++ )
                {
                    ...
                    // Roll_Number
                        ...
                        cout << stg_t;
                        Utilities::spaces(stg_t.size() ,25);
                        cout << "|" << endl;
...
- Fixed : Errors were not displaying on "Output Generation" Screen
- Fixed : Obtained Marks verification
- Fixed : Crash on "Subject-wise list Generation" while "text file generation"
- Fixed : Crash on "All Lists Generation" while "text file generation"
- Fixed : Minor Spell mistakes in Menus

- Added : Error Messages
- Added : Proper Output message for Errors. 
- Added : Errors are now according to the current Menu size
- Added : Error Status at the front of many errors
- Added : Obtained Marks are now checked for range of total marks
...
- And lot more minor improvements
