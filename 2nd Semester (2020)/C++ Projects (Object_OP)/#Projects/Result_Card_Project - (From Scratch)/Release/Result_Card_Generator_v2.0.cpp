...
namespace Result_External
{
    ...
    void Subject_wise(vector<Profile> &students)
    {
        ...
        // Result Card
            ...
            {
                ofstream Brilliant_Student ( (students[i].subjects[i].name + ".txt") );
        ...
        // Menu For Type of Result
            ...
            switch (temp_i)
            {
                ...
                case 8:
                {
                    ...
                    cout << " | be lost, When you go to Mein Menu. Press \"Enter\" to go back |" << endl;
                    cout << " | to previous menu, or Enter: \"99\" to go to Main Menu.        |" << endl;
                    cout << " +-------------------------------------------------------------+" << endl;
                    cout << " |" << endl;
                    cout << " +---[Confirm]--> ";
                    getline(cin, temp_s); cin.clear(); cin.sync();
            ...
            cout << " | 3. Output Lists Generation                                  |" << endl;
            cout << " |                                                             |" << endl;
            cout << " +-------------------------------------------------------------+" << endl;
            cout << " |" << endl;
            cout << " +--[Input]--> ";
